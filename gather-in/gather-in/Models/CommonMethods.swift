...
public let CurrentYear = Calendar.current.component(.year, from: Date())
...
public func isEnglish() -> Bool {
    if L102Language.isRTL { return false } else { return true }
}
/// change language
func changeLanguage(showController controller: String , storyBoard: String){
    ...
    pushToView(withId: controller, withStoryBoard: storyBoard)
...
//public func handleStarView(forView rateView: CosmosView, withRate rate: Double,isTouch:Bool, size: Int)
//{
...
//    rateView.settings.starSize = Double(iphoneXFactor*CGFloat(size))
//    rateView.settings.starMargin = Double(iphoneXFactor*5)
//    rateView.settings.emptyImage = UIImage(named: "star_large_unsel-1")
//    rateView.settings.filledImage = UIImage(named: "star_large_unsel")
//}
...
//        pushToView(withId: "LoginViewController", withStoryBoard: Storyboards.MAIN_OWNER.rawValue)
//    }
//}
//
...
func pushToView(withId:String, withStoryBoard storyBoard: String){
...
public func goNavigation(controllerId: String, controller: UIViewController, Storyboard board: String){
    let main = UIStoryboard(name: board, bundle: nil)
...
//    view.bodyLabel?.font = UIFont(name: localizedSitringFor(key: "regFont"), size: iphoneXFactor*13)
//    view.titleLabel?.font = UIFont(name: localizedSitringFor(key: "regFont"), size: iphoneXFactor*13)
//    view.alpha = 0.9
...
public func addRedDotAtTabBarItemIndex(parant: UIViewController,index: Int) {
    ...
    let redDot = UIView(frame: CGRect(x: xOffset + imageHalfWidth - 8, y: TopMargin, width: RedDotDiameter, height: RedDotDiameter))
...
//    func customFont(){
//        if let font = UIFont(name: localizedSitringFor(key: "regFont"), size: iphoneXFactor*13){
//            self.textFont = font
//        }
//    }
//}
extension UISearchBar{
    func customFont(){
        let defaultTextAttributes = [ NSAttributedString.Key.font: UIFont.init(name: localizedSitringFor(key: "regFont"), size: 16), NSAttributedString.Key.foregroundColor: UIColor.gray ]
        UITextField.appearance(whenContainedInInstancesOf: [UISearchBar.self]).defaultTextAttributes = defaultTextAttributes as [NSAttributedString.Key : Any]
        if isEnglish() {
